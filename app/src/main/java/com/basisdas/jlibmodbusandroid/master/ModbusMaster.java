package com.basisdas.jlibmodbusandroid.master;
...
import com.basisdas.jlibmodbusandroid.msg.ModbusRequestBuilder;
import com.basisdas.jlibmodbusandroid.msg.ModbusRequestFactory;
import com.basisdas.jlibmodbusandroid.msg.base.ModbusFileRecord;
...
import com.basisdas.jlibmodbusandroid.msg.base.mei.MEIReadDeviceIdentification;
import com.basisdas.jlibmodbusandroid.msg.base.mei.ReadDeviceIdentificationCode;
import com.basisdas.jlibmodbusandroid.msg.response.*;
import com.basisdas.jlibmodbusandroid.net.ModbusConnection;
import com.basisdas.jlibmodbusandroid.net.transport.ModbusTransport;
import com.basisdas.jlibmodbusandroid.utils.FrameEvent;
import com.basisdas.jlibmodbusandroid.utils.FrameEventListener;
import com.basisdas.jlibmodbusandroid.utils.FrameEventListenerList;
import com.basisdas.jlibmodbusandroid.utils.ModbusExceptionCode;
...
abstract public class ModbusMaster implements FrameEventListenerList {
     ...
     * @see ModbusRequest
     * @see ModbusResponse
     * @see com.basisdas.jlibmodbusandroid.msg.request
     * @see com.basisdas.jlibmodbusandroid.msg.request
     */
    synchronized public ModbusResponse processRequest(ModbusRequest request) throws ModbusProtocolException, ModbusIOException {
        try {
            ...
            //disconnect(); //fixme: disconnect by timeout
            throw mioe;
        }
    }
