...
public class SerialParameters {
    ...
    public String getParametersString()
        ...
        sb.append("Битовая скорость: ");
        sb.append(Integer.toString(this.getBaudRate()));
        sb.append("\r\n");

        sb.append("Бит данных: ");
        sb.append(Integer.toString(this.getDataBits()));
        sb.append("\r\n");

        sb.append("Стоп бит: ");
        sb.append(Integer.toString(this.getStopBits()));
        sb.append("\r\n");

        sb.append("Контроль чётности: ");
        sb.append(this.getParity().name());
